...
import static com.example.checking.Main2Activity.gs1;
...
public class CustomView1 extends View {
    ...
    public void launch() {
        ...
        else if(countscore3 > countscore1 && countscore3 > countscore2)
    ...
    private void init(@Nullable AttributeSet set) {
        ...
        paint7.setColor(Color.rgb(72, 218, 85));
        if (set == null)
            return;
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        rect2.top = 0;
        rect2.bottom = (float) (getHeight() / 10 * 2);
        rect2.left = 0;
        ...
        painttext3.setColor(Color.GREEN);
        painttext.setTextSize(100);
        painttext.setColor(Color.WHITE);
        canvas.drawText(String.valueOf(countscore2), getWidth() / 3 - 25, getHeight() / 12, painttext1);
        canvas.drawText(String.valueOf(countscore1), getWidth() / 3 * 2 - 25, getHeight() / 12, painttext2);
        canvas.drawText(String.valueOf(countscore3), getWidth() / 3-25, getHeight() / 12 * 2, painttext3);
                        ...
                        if ((Yco.get(i) - 20) < y && (Yco.get(i) + 20) > y) {
                            if (playerturn != 0) {
                                for (int q = 0; q < Co.size(); q++) {
                                    if (Xco.get(k) == Co.get(4 * q) && Yco.get
                                            (i) == Co.get(4 * q + 1) && Xco.get(k + 1) == Co.get(4 * q + 2) && Yco.get(i) == Co.get(4 * q + 3)) {
                                        count++;
                                        break;
                                    } else {
                                        count = 0;
                    ...
                    if (point1 == true && point2 == true && point3 == true && point4 == true) {
                        ...
                        if (sqtruth != true) {
                            ...
                            if (playerturn % 3 == 0) {
                                ...
                                sq.add(new Square(Xco.get(k1), Yco.get(l1), Xco.get(k1 + (GRID_SIZE + 1)), Yco.get(l1 + 1), paint7, playerturn));
                                Sqlist.add(Xco.get(k1));
                                Sqlist.add(Yco.get(l1));
                                Sqlist.add(Xco.get(k1 + (GRID_SIZE + 1)));
                                Sqlist.add(Yco.get(l1 + 1));
